...
public class DestinationsConfig extends Config {
    ...
    protected void reset() {
        ...
        xpCostMultiplier = new Option.DoubleValue(0.0001, "The multiplier for the cost of XP during travel. Calculation is cost = distanceInBlocks * multiplier. Set to 0 for no cost. 0.0001 = 1 level per 10,000 blocks");
    ...
    public int getCost(int distance) {
        return (int) Math.ceil((double) distance * this.xpCostMultiplier.getValue());
    }
